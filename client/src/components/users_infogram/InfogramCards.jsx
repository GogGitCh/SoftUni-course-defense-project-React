                ...
                {/* <div className={styles['infogram-cards-wrapper']}> */}
                    <ul className={styles['ul']}>
                        <li className={styles['li']}>
                            ...
                            <img className={styles['img']} src="../../../public/images/infogram_cards/Image1_1.jpg" /></li>
                        <li className={styles['li']}>
                            <p className={styles['p']}>Apprentice</p>
                            <img className={styles['img']} src="../../../public/images/infogram_cards/Image2_2.jpg" /></li>
                        <li className={styles['li']}>
                            <p className={styles['p']}>Client</p>
                            <img className={styles['img']} src="../../../public/images/infogram_cards/Image3_3.jpg" /></li>
                        <li className={styles['li']}>
                            <p className={styles['p']}>Preparer</p>
                            <img className={styles['img']} src="../../../public/images/infogram_cards/Image4_4.jpg" /></li>
                    </ul>
                {/* </div> */}
            </section>
        </div>
